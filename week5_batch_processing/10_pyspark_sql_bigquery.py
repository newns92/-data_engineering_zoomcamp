...
# connect to the Google Cloud Dataproc Temp Bucket
spark.conf.set('temporaryGcsBucket', 'dataproc-temp-northamerica-northeast2-404348555020-5mf3pmyc')
