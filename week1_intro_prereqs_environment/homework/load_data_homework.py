...
def main(args):
    ...
    taxi_csv_name = "./data/green_tripdata_2019-10.csv"
    ...
    # Add the column headers to the green_taxi_data table in the Postgres 
    ...
    ## CAN NOW SEE THE EMPTY TABLE IN pgcli and inspect it via `\d green_taxi_data`
