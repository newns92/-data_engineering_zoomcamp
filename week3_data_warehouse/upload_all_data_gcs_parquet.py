...
## Set the download directory URL
init_url = 'https://github.com/DataTalksClub/nyc-tlc-data/releases/download/'
## Switch out the GCP credentials and GCS bucketname
...
def web_to_gcs(year, service, gcs_bucket):
    ...
    # for i in range(3):
        ...
        ## Uncompress and read data into a pandas DataFrame
        ...
        ## Replace the extension and read DataFrame into a Parquet file using `pyarrow` engine
